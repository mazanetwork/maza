# Linearize
Construct a linear, no-fork, best version of the Maza blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install maza_hash

https://github.com/mazacoin/maza_hash
...
JSON-RPC server. Running `mazad` or `maza-qt -server` will be sufficient.
...
* `input`: mazad blocks/ directory containing blkNNNNN.dat
