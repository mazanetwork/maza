...
while read line ; do
  ...
  while read filename ; do
    ...
    sed -i.bkp -e 's/mazacoin/dashpay/g' -e 's/Maza/Dash/g' -e 's/MAZA/DASH/g' -e 's/maza/dash/g' $filename
...
EOF
while read line ; do 
  fname=$(echo $line | sed 's/maza/dash/g')
  mv $line $fname 
...
#diff -r ./src/clientversion.cpp ../dash_untouched/src/clientversion.cpp
#16c16
#< const std::string CLIENT_NAME("Buffalo");
#---
#> const std::string CLIENT_NAME("Dash Core");
#diff -r ./src/clientversion.h ../dash_untouched/src/clientversion.h
#41c41
...
#
#diff -r ./src/validation.cpp ../dash_untouched/src/validation.cpp
#106c106
#< const std::string strMessageMagic = "Dash Signed Message:\n";
#---
#> const std::string strMessageMagic = "DarkCoin Signed Message:\n";

#diff -r ./src/qt/locale/dash_sk.ts ../dash_untouched/src/qt/locale/dash_sk.ts
#2237c2237
#<         <translation>Vydashť konzolu</translation>
#---
#>         <translation>Vymazať konzolu</translation>
#2869c2869
#<         <translation>Zdashť &amp;všetko</translation>
#---
...
#>         <translation>Zmazať &amp;všetko</translation>
#4046c4046
#<         <translation>Vydashť všetky transakcie z peňaženky a pri spustení znova získať z reťazca blokov iba tie získané pomocou -rescan</translation>
#---
...
#4078c4078
#<         <translation>Uistite sa, že máte´Vašu peňaženku zašifrovanú a zdashné všetky nezašifrované zálohy potom, ako overíte, že peňaženka funguje! </translation>
#---
...
#5342c5342
#<         <translation>Vydashť všetky transakcie z peňaženky...</translation>
#---
