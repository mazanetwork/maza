...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 MAZA.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 MAZA on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the maza github repo](https://github.com/mazacoin/maza/blob/master/doc/masternode_conf.md)
...
If you generated a new masternode private key, you will need to update the remote `maza.conf` files.

Shut down the daemon and then edit the file.

```nano .mazacore/maza.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `maza.conf` file.
...
Search your Masternodes on https://mazaninja.pl/masternodes.html
