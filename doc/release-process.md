...
space *do not upload these to the dashpay.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the dashpay.org server

- Update dashpay.org

- Announce the release:

  - Release on Dash forum: https://www.dashpay.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Dashpay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~dashpay.org/+archive/ubuntu/dash)
