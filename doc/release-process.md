...
### Maza Core maintainers/release engineers, update (commit) version in sources
...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/Mazapay, ... but this will usually sort out itself
