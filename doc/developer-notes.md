...
Maza Network is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadCheckDarkSendPool : Runs mazanode list and sync data update loops
...
However, in open source software such as Maza Network, where everyone uses
...
pay attention to for reviewers of Maza Network code.

General Maza Network
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Maza Network uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Maza Network so that they can be integrated
