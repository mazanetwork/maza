...
Maza Network version 0.12.0 is now available from:
...
backwards-compatible with pre-0.12 versions of Maza Network or other software:
...
- Implemented new decentralized mazanode payment consensus system
- Improved speed of DS
- New mazanode payment/winners/budgets syncing strategy
- Platform independent mazanode ranking system
- Mazanode broadcasts, pings and winners now use the inventory system
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/maza/).
