...
Detailed [change log](https://github.com/mazacoin/maza/compare/v0.12.1.x...mazapay:v0.12.2.x) below.
...
- [`b39c518d5`](https://github.com/mazacoin/maza/commit/b39c518d5) Backport Bitcoin PR#7749: Enforce expected outbound services (#1508)
...
- [`91d99fcd3`](https://github.com/mazacoin/maza/commit/91d99fcd3) Backport Bitcoin Qt/Gui changes up to 0.14.x part 3 (#1617)
...
- [`ea793a71f`](https://github.com/mazacoin/maza/commit/ea793a71f) Make sure mixing masternode follows bip69 before signing final mixing tx (#1510)
...
- [`d7a8489f3`](https://github.com/mazacoin/maza/commit/d7a8489f3) Fix masternode score/rank calculations (#1620)
...
- [`916af52c0`](https://github.com/mazacoin/maza/commit/916af52c0) Fix vulnerability with mapMasternodeOrphanObjects (#1512)
- [`70eb83a5c`](https://github.com/mazacoin/maza/commit/70eb83a5c) New rpc call "masternodelist info" (#1513)
...
- [`4942884c7`](https://github.com/mazacoin/maza/commit/4942884c7) fix potential deadlock in CMasternodeMan::CheckMnbAndUpdateMasternodeList (#1543)
- [`4ed838cb5`](https://github.com/mazacoin/maza/commit/4ed838cb5) Fix MasternodeRateCheck (#1490)
...
- [`9e9df2820`](https://github.com/mazacoin/maza/commit/9e9df2820) do not use masternode connections in feeler logic (#1533)
...
- [`8da26da71`](https://github.com/mazacoin/maza/commit/8da26da71) Eliminate g_connman use in spork module. (#1613)
- [`4956ba7a7`](https://github.com/mazacoin/maza/commit/4956ba7a7) Eliminate g_connman use in instantx module. (#1626)
- [`10eddb52d`](https://github.com/mazacoin/maza/commit/10eddb52d) Move some (spamy) CMasternodeSync log messages to new `mnsync` log category (#1630)
...
### RPC:
- [`a0851494d`](https://github.com/mazacoin/maza/commit/a0851494d) add `masternodelist pubkey` to rpc (#1549)
- [`825b3ccc9`](https://github.com/mazacoin/maza/commit/825b3ccc9) more "vin" -> "outpoint" in masternode rpc output (#1633)
- [`0c1679e58`](https://github.com/mazacoin/maza/commit/0c1679e58) fix `masternode current` rpc (#1640)
...
- [`32ad53e77`](https://github.com/mazacoin/maza/commit/32ad53e77) Revert "fix `masternode current` rpc (#1640)" (#1681)
...
- [`e0d6c5b5a`](https://github.com/mazacoin/maza/commit/e0d6c5b5a) fixed potential deadlock in CMasternodePing::SimpleCheck (#1534)
- [`8b5f47e68`](https://github.com/mazacoin/maza/commit/8b5f47e68) Masternode classes: Remove repeated/un-needed code and data (#1572)
...
- [`8012f2ca7`](https://github.com/mazacoin/maza/commit/8012f2ca7) drop masternode index (#1580)
- [`b5f7be649`](https://github.com/mazacoin/maza/commit/b5f7be649) slightly refactor CDSNotificationInterface (#1581)
- [`9028a22b8`](https://github.com/mazacoin/maza/commit/9028a22b8) safe version of GetMasternodeByRank (#1595)
- [`05da4557d`](https://github.com/mazacoin/maza/commit/05da4557d) Refactor masternode management (#1611)
...
- [`7a5943c3a`](https://github.com/mazacoin/maza/commit/7a5943c3a) Merge pull request #1431 from mazapay/v0.12.2.x-merge_upstream
...
- [`549b659e8`](https://github.com/mazacoin/maza/commit/549b659e8) Force self-recheck on CActiveMasternode::ManageStateRemote() (#1441)
...
- [`02e882c3d`](https://github.com/mazacoin/maza/commit/02e882c3d) bump MIN_MASTERNODE_PAYMENT_PROTO_VERSION_2 and PROTOCOL_VERSION to 70208 (#1636)
...
- [`46342b2e8`](https://github.com/mazacoin/maza/commit/46342b2e8) update nCollateralMinConfBlockHash for local (hot) masternode on mn start (#1689)
...
Maza Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to Maza.
