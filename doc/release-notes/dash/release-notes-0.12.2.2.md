...
To fix this issue in Maza Core however, we had to backport a lot of other
...
it should be possible to compile Maza Core with `--disable-wallet` option now.
...
See detailed [change log](https://github.com/mazacoin/maza/compare/v0.12.2.1...mazapay:v0.12.2.2) below.
...
- [`753cb1563`](https://github.com/mazacoin/maza/commit/753cb1563) Backport #7874: Improve AlreadyHave
...
- [`4102211a3`](https://github.com/mazacoin/maza/commit/4102211a3) Backport #10526: Force on-the-fly compaction during pertxout upgrade
...
### Masternodes:
- [`312663b4b`](https://github.com/mazacoin/maza/commit/312663b4b) Remove support for local masternodes (#1706)
...
- [`86e6f0dd2`](https://github.com/mazacoin/maza/commit/86e6f0dd2) Fix CMasternodeMan::ProcessVerify* logs (#1782)
