...
This document provides guidelines for internationalization of the Maza Network software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `maza_en.ts` remains unchanged.
