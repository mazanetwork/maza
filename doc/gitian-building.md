...
*Setup instructions for a Gitian build of Maza Network using a Debian VM or physical system.*
...
- [Building Maza Network](#building-maza-core)
...
Clone the git repositories for Maza Network and Gitian.
...
in the Maza Network repository under 'Fetch and create inputs' to install sources which require
manual intervention. Also optionally follow the next step: 'Seed the Gitian sources cache
and offline git repositories' which will fetch the remaining files required for building
offline.

Building Maza Network
----------------

To build Maza Network (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Maza Network repository.
...
For example:
```bash
URL=https://github.com/crowning-/maza.git
...
[maza/gitian.sigs](https://github.com/mazacoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
