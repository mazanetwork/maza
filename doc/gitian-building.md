...
Clone the git repositories for Maza Core and Gitian.
...
in the Maza Core repository under 'Fetch and create inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the Maza Core repository.
