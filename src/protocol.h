...
extern const char *MAZANODEPAYMENTVOTE;
extern const char *MAZANODEPAYMENTSYNC;
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Maza Network nodes, and is unset by SPV clients or other peers that just want
    // network services but don't provide them.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // Maza Network does not support this but a patch set called Bitcoin XT does.
    // See BIP 64 for details on how this is implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Maza Network nodes used to support this by default, without advertising this bit,
...
enum GetDataMsg {
    ...
    MSG_TXLOCK_VOTE = 5,
    MSG_SPORK = 6,
    MSG_MAZANODE_PAYMENT_VOTE = 7,
    MSG_MAZANODE_PAYMENT_BLOCK = 8, // reusing, was MSG_MAZANODE_SCANNING_ERROR previousely, was NOT used in 12.0
    ...
    MSG_MAZANODE_QUORUM = 13, // not implemented
    MSG_MAZANODE_ANNOUNCE = 14,
    MSG_MAZANODE_PING = 15,
    MSG_DSTX = 16,
    MSG_GOVERNANCE_OBJECT = 17,
    MSG_GOVERNANCE_OBJECT_VOTE = 18,
    MSG_MAZANODE_VERIFY = 19,
