...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_1000, // find mazanode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000MAZA output and keys which can be used for the Mazanode
    bool GetMazanodeOutpointAndKeys(COutPoint& outpointRet, CPubKey& pubKeyRet, CKey& keyRet, const std::string& strTxHash = "", const std::string& strOutputIndex = "");
