...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Maza address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "maza",               "masternode",             &masternode,             true,  {} },
    { "maza",               "masternodelist",         &masternodelist,         true,  {} },
    { "maza",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
