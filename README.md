...
3) moves all significant deviations from bitcoin out of the main code so differences betwee DASH and BTC are clear
4) provides a proper testnet environment



Dash Core integration/staging tree
=====================================
...
Translators should also follow the [forum](https://www.dashpay.org/forum/topic/dash-worldwide-collaboration.88/).
