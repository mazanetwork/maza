...
Maza Network integration/staging tree
=====================================
...
are carried out collectively by the network. Maza Network is the name of the open
source software which enables the use of this currency.

For more information, as well as an immediately useable, binary version of
the Maza Network software, see https://www.mazacoin.io/downloads.


License
-------

Maza Network is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
stable release versions of Maza Network.
...
[Maza Network's Transifex page](https://www.transifex.com/projects/p/maza/).
